	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			...
			<td class="ct_write01">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<%-- <td width="105"><%=vo.get("prodName") %></td>--%>
		...
		<tr>
			...
			<td bgcolor="D6D6D6" width="1"></td>
			<%-- <td class="ct_write01"><%=vo.get("prodDetail") %> </td>--%>
		...
		<tr>
			...
			<td bgcolor="D6D6D6" width="1"></td>
			<%-- <td class="ct_write01"><%=vo.get("manuDate") %>	</td>--%>
		...
		<tr>
			...
			<td bgcolor="D6D6D6" width="1"></td>
			<%--<td class="ct_write01"><%=vo.get("price") %></td>--%>
		...
		<tr>
			...
			<td class="ct_write01">
				...
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						<%--<td height="26"><%=vo.get("fileName") %></td>--%>
				...
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td background="/images/ct_btnbg02.gif" class="ct_btn01"
							...
							<!-- <a href="/product/listProduct?menu=manage">확인</a> -->확인
						</td>
						...
						<td background="/images/ct_btnbg02.gif" class="ct_btn01"
							style="padding-top: 3px;">
							<!-- <a href="../product/addProductView.jsp;">추가등록</a> -->추가등록
						</td>
						<td width="14" height="23"><img src="/images/ct_btnbg03.gif"
							width="14" height="23" /></td>
					</tr>
