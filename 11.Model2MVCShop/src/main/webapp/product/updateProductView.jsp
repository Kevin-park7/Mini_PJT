...
<%--
	...
	System.out.println("updateProd >>>>>>>>>;;"+vo);
--%>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							<td width="105">
								<%--<input 	type="text" name="prodName"value="<%=vo.getProdName() %>" class="ct_input_g" 
										style="width: 100px; height: 19px" maxLength="20" value="자전거"> --%>
								<input type="text" name="prodName" value="${prod.prodName}"
								class="ct_input_g" style="width: 100px; height: 19px"
								maxLength="20" value="자전거">
							</td>
						</tr>
					</table>
				</td>
			...
			<tr>
				...
				<td class="ct_write01">
					...
					<input type="text" name="prodDetail" value="${prod.prodDetail}"
					class="ct_input_g" style="width: 100px; height: 19px"
			...
			<tr>
				...
				<td bgcolor="D6D6D6" width="1"></td>
				<td class="ct_write01">
					<%--<input type="text" name="manuDate" readonly="readonly" value="<%=vo.getManuDate() %>" --%>
					<input type="text" name="manuDate" readonly="readonly"
					value="${prod.manuDate}" class="ct_input_g"
					style="width: 100px; height: 19px" maxLength="10" minLength="6">&nbsp;
			...
			<tr>
				...
				<td bgcolor="D6D6D6" width="1"></td>
				<td class="ct_write01">
					<input type="text" name="amount" value="${prod.amount}"
					class="ct_input_g" style="width: 100px; height: 19px"
					maxLength="50" />
				</td>
			</tr>
			...
			<tr>
				...
				<td class="ct_write01">
					...
					<input type="text" name="fileName" value="${prod.fileName}"
					class="ct_input_g" style="width: 200px; height: 19px"
					maxLength="13" value="../../images/empty.GIF" />
				</td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
