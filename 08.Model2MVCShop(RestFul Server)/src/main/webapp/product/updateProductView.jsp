...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="105">
						...
						<input 	type="text" name="prodName"value="${prod.prodName}" class="ct_input_g" 
										style="width: 100px; height: 19px" maxLength="20" value="자전거">
					</td>
				</tr>
			</table>
	...
	<tr>
		...
		<td class="ct_write01">
			...
			<input type="text" name="manuDate" readonly="readonly" value="${prod.manuDate}" 	
	...
	<tr>
		...
		<td class="ct_write01">
			...
			<input	type="text" name="fileName" value="${prod.fileName}"class="ct_input_g" 
