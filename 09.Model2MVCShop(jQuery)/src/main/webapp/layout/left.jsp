	...
	<tr>
		<td valign="top"> 
			<table  border="0" cellspacing="0" cellpadding="0" width="159">
				<tr>
					<td class="Depth03">
						<!-- <a href="../product/addProductView.jsp;" target="rightFrame">판매상품등록</a> -->판매상품등록
					</td>
				</tr>
				<tr>
					<td class="Depth03">
						<!-- <a href="/listProduct.do?menu=manage"  target="rightFrame">판매상품관리</a> -->판매상품관리
					</td>
				</tr>
				<tr>
					<td class="DepthEnd">&nbsp;</td>
...
<tr>
	<td valign="top"> 
		<table  border="0" cellspacing="0" cellpadding="0" width="159">
			<tr>
				<td class="Depth03">
					<!--<a href="/listProduct.do?menu=search" target="rightFrame">상 품 검 색</a> -->상 품 검 색
				</td>
			</tr>
			...
			<tr>
				<td class="Depth03">
					<!--<a href="/listPurchase.do"  target="rightFrame">구매이력조회</a> -->구매이력조회
				</td>
			</tr>
			</c:if>
