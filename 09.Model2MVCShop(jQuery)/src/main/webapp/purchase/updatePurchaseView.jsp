...
System.out.println(">> UpdatePurchase: "+ uservo.getUserId());
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<input type="hidden" name="buyer.userId" value="${vo.buyer.userId}">
	...
	<tr>
		<td width="104" class="ct_write">구매방법${vo.paymentOption}</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
