...
public class CommonUtil {
	...
	///Field
	//jap에서 페이지에서 null을 처리해준다 
	///Constructor
	
	///Method
	/**
	 * String 타입의 입력값이 null일 때, converted로 반환
	 * @param org, String, 변환할 변수
	 * @param converted, String, 변경할 값
	 * @return String, org가 null일 때 converted, null이 아닐 때, ..
	 */
