...
public class PurchaseDAO {
	...
	public Purchase findPurchase(int tranNo )throws Exception{
		...
		System.out.println("DAO purchase find");
		//System.out.println("DAO purchase >>"+rs.getString("buyer_id"));
	...
	public Purchase findPurchase2 (int prodNo)throws Exception{
		...
		String sql = "select t.tran_no,t.tran_status_code "
...
private int getTotalCount(String sql)throws Exception {
	System.out.println("totalCount 11"+sql);
	sql = "SELECT COUNT(*) "+
			"FROM ("+sql+") countTable";
	System.out.println("totalCount 22"+sql);
	Connection con = DBUtil.getConnection();
	PreparedStatement stmt = con.prepareStatement(sql);
	ResultSet rs = stmt.executeQuery();
